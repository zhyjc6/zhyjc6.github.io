...
// 回到顶部
blog.addLoadEvent(function() {
  var backTopDom = document.getElementById('back-top')
  ...
  function toggleButton() {
    if (getScrollTop() > 200) {
      blog.addClass(backTopDom, 'show')
    } else {
      blog.removeClass(backTopDom, 'show')
    }
  }

  blog.addEvent(window, 'scroll', toggleButton)

  blog.addEvent(backTopDom, 'click', function(event) {
    window.scrollTo(0,0)
